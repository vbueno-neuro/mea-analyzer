...
1_, 2_, 3_ → subsequent time points
...
⚠️ Always run the notebook from top to bottom.
...
### 7.3 Decide whether to remove outliers
```
REMOVE_OUTLIERS = True   # or False
```

### 7.4 Baseline normalization
```
...
- Statistics are time-point–specific
...
✅ You are now ready to analyze MEA data!
